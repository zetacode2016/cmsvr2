...
namespace CMS2.CentralWeb.Controllers
{
    public class AccountController : Controller
    {
        ...
        //    model.CreatedBy = Guid.Parse("{00000000-0000-0000-0000-000000000000}");
        //    model.ModifiedDate = DateTime.Now;
        //    model.ModifiedBy = Guid.Parse("{00000000-0000-0000-0000-000000000000}");
        //    model.RecordStatus = (int) RecordStatus.Active;
        //    if (ModelState.IsValid)
        //    {
        //        var user = new IdentityUser() { Id = Guid.NewGuid(), UserName = model.UserName };
