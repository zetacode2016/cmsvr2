...
{
    public class GatewaySatOfficeController : AdminBaseController
    {
        private GatewaySatOfficeBL service = new GatewaySatOfficeBL();
        ...
        public ActionResult Add(RevenueUnit model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                model.RevenueUnitTypeId = Guid.Parse(RevenueUnitTypeId.GatewaySat);
