...
{
    public class AccountStatusController : AdminBaseController
    {
        private AccountStatusBL service = new AccountStatusBL();
        ...
        public ActionResult Add(AccountStatus model)
        {
            if (ModelState.IsValid)
            {
                model.AccountStatusId = Guid.NewGuid();
        ...
        public ActionResult Edit(AccountStatus model)
        {
            if (ModelState.IsValid)
            {
                var _model = service.GetById(model.AccountStatusId);
                _model.AccountStatusName = model.AccountStatusName;
