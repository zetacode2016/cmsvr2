                        ...
                        try
                        {
                            ...
                            if (previousShipmentId != currentShipmentId)
                            {
                                ...
                                if (userAssignment == null)
                                    userAssignment = new EmployeePositionMapping();
                                else
                                {
                                    var revenueunit = (RevenueUnit)userAssignment.AssignedLocation;
                                    ...
                                    else if (item.cTransferTo.Equals("Airlines"))
                                    {
                                        ...
                                        model.TransferFromId =
                                            revenueunit.Cluster.BranchCorpOffice.BranchCorpOfficeId;
                                        //model.TransferToId =
                                        //    gatewayService.FilterBy(x => x.GatewayName.Equals(item.cBranchAirlines))
                                        //        .FirstOrDefault()
                                        //        .GatewayId;
                                    }
                                    var employeeAssignments = employeePositionService.GetByDatePosition(item.dDateTime ?? DateTime.Now, "Driver");
                                    if (employeeAssignments != null)
                                    {
                                        ...
                                        {
                                            employeeName = (assign.Employee.FirstName.Substring(0, 1) + "." + assign.Employee.LastName).ToUpper().Trim();
                                            if (employeeName.Equals(driverName))
                                            {
                                                model.DriverId = assign.Employee.EmployeeId;
                    ...
                    if (!packageNumberAcceptanceService.IsExistInAcceptance(item.cCargo, AcceptanceTypeConstant.AreaToBco))
                    {
                        try
                        {
                            ...
                            if (previousShipmentId != currentShipmentId)
                            {
                                ...
                                if (userAssignment != null)
                                {
                                    revenueUnit = (RevenueUnit) userAssignment.AssignedLocation;
                                    model.TransferToId = revenueUnit.Cluster.BranchCorpOffice.BranchCorpOfficeId;
                                }

                                var driverAssignments = employeePositionService.GetByDatePosition(item.dDateTime ?? DateTime.Now, "Driver");
                                if (driverAssignments != null)
                                {
                                    ...
                                    {
                                        employeeName =
                                            (assign.Employee.FirstName.Substring(0, 1) + "." + assign.Employee.LastName)
                                                .ToUpper().Trim();
                                        if (employeeName.Equals(driverName))
                                        {
                                            model.DriverId = assign.EmployeeId;
                                            revenueUnit = assign.AssignedLocation;
                                            model.TransferFromId = revenueUnit.RevenueUnitId;
                                        }
                                    }
                                }
                                var fieldRepAssignments = employeePositionService.GetByDatePosition(item.dDateTime ?? DateTime.Now, "Field Rep");
                            ...
                            if (previousShipmentId != currentShipmentId)
                            {
                                ...
                                if (driverAssignments != null)
                                {
                                    ...
                                    foreach (var assign in driverAssignments)
                                    {
                                        ...
                                        if (employeeName.Equals(driverName))
                                        {
                                            var revenueunit = (RevenueUnit) assign.AssignedLocation;
                                            model.DriverId = assign.EmployeeId;
                                            model.TransferFromId = revenueunit.Cluster.BranchCorpOffice.BranchCorpOfficeId;
                            ...
                            if (previousShipmentId != currentShipmentId)
                            {
                                ...
                                if (driverAssignments != null)
                                {
                                    ...
                                    foreach (var assign in driverAssignments)
                                    {
                                        ...
                                        {
                                            model.DriverId = assign.EmployeeId;
                                            revenueUnit = (RevenueUnit) assign.AssignedLocation;
                                            model.TransferFromId = revenueUnit.RevenueUnitId;
                                        }
                                    }
                                }
